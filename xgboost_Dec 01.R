...
train <- fread('/Users/chidam/data_sci/data/otto product classification/train-3.csv', header = T, stringsAsFactors = F)
#str(train)
test <- fread('/Users/chidam/data_sci/data/otto product classification/test.csv', header=TRUE, stringsAsFactors = F)
## Check teh dimensions of the train & test data frames
dim(train)
...
setwd("/Users/chidam/data_sci/data/otto product classification")
str(submit)
#submit1=as.data.frame(lapply(submit,as.integer))
#str(submit1)
